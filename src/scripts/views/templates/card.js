...
const createMenuCard = (foodOrDrink, i, type) => `
        <div class="menu-card">
            <img class="lazyload" data-src="${getRandomImage(type, i)}" alt="food and drink" crossorigin="anonymous">
...
const createReviewCard = (review, i) => `
        <div class="review-card">
            <div class="avatar">
                <img class="lazyload" data-src="${getRandomImage('avatar', i)}" alt="profile picture" crossorigin="anonymous">
            </div>
            <div class="review">
